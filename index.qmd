...
```r
# R code for creating Figure 1 would go here
# This figure shows post-surgical outcomes by patient for observational data
```
:::
...
```r
# R code for creating Figure 2 would go here
# This figure shows post-surgical outcomes for randomized assignment
```
:::
...
# Add text annotations for means (positioned on the right side)
x_max = max(patients_df['severity'].max(), abs(patients_df['severity'].min()))
ax.text(x_max * 1.05, dreamy_mean, f'○ {dreamy_mean:.2f}', 
        color='#4E79A7', fontsize=11, fontweight='bold', 
        verticalalignment='center', zorder=4)
ax.text(x_max * 1.05, duck_mean, f'△ {duck_mean:.2f}', 
        color='#E15759', fontsize=11, fontweight='bold', 
        verticalalignment='center', zorder=4)
...
```r
# R code for creating Figure 3 would go here
# This figure shows post-surgical outcomes by patient severity (stratification)
```
:::
